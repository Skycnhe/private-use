...
class CloudflareNodeTester:
    ...
    def fetch_known_nodes(self):
        ...
        # 这里添加了更多常用于台湾方向的网段
        ip_ranges = [
            '172.67.229.0/24',  # 原有网段
            '103.22.200.0/24',  # 常见CF台湾
            '103.22.201.0/24',  # 常见CF台湾
            '103.31.4.0/24',    # 常见CF台湾
            '103.31.5.0/24',    # 常见CF台湾
            '103.31.6.0/24',    # 常见CF台湾
            '172.68.0.0/24',    # 常见CF泛播
            '141.101.64.0/24',  # 备选网段
            '104.19.235.0/24',  # 备选网段
            '104.28.22.0/24'    # 备选网段
        ]
