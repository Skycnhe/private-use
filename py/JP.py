...
def batch_query_ip_countries():
    ...
    try:
        ...
        ip_list = [
            ...
            "162.159.0.4", "162.159.0.1", "162.159.0.3", "108.162.192.2", "108.28.165.0"
        ]
    ...
    # 将结果写入文件
    # 注意：IP_COUNTRIES_FILE 变量在原代码中未定义，需确保使用正确的文件名
    IP_COUNTRIES_FILE = "IP_Countries.txt" 
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"程序出错: {e}")        # 这些IP看起来是Cloudflare的IP地址
        octets = ip.split('.')
        if octets[0] == '104' and octets[1] == '18':
            return '美国'  # Cloudflare US IPs
        elif octets[0] == '108' and octets[1] == '162':
